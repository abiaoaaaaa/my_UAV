...
model = DDPG("MlpPolicy", envs, verbose=1, action_noise=action_noise, tensorboard_log="./tensorboard/",
             device="cuda")
# 开始训练
...
# 保存模型到相应的目录
model.save("C:/Users/10749/Desktop/my_UAV/PathPlaning/TrainedModel/Actor_w0.1.pkl")
