...
class DroneEnv(gym.Env):
    def __init__(self):
        ...
        #观察空间
        #障碍物
        self.observation_space = gym.spaces.Box(low=np.array([ 0, 0, 0, 0, 0, 0, 0, 0, -1]), high=np.array([ 1, 1, 1, 1, 1, 1, 1, 1, 1]), dtype=np.float32)
        ...
        self.heading = 0
        self.goal = [600, 800]
        self.obstacles = [[200, 200], [500, 700]]
    ...
    def step(self, action):
        ...
        # 更新状态
        self.heading = (self.heading + action[0]) % (2 * np.pi)
    ...
    def render(self, mode='human'):
        ...
        pass
    def calculate_reward(self, d_lod):
        # 计算奖励
    ...
    def _human_render(self):
        ...
        plt.scatter(self.xy[0], self.xy[1], marker='o', color='red', label='Drone',s=1)
        #plt.show()
